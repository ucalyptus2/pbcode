...
from predibase.pql.api import PredibaseServerError, Session
...
class Connection:
    ...
    def import_dataset(self, object_name: str, dataset_name: str, exists_ok: bool = False) -> "Dataset":  # noqa
        if not self.session.is_plan_expired():
            ...
            except PredibaseServerError as e:
                # TODO: fix this -- need to check status code but this isn't attached to the error
                if exists_ok:
